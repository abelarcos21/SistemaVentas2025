                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-gradient-primary text-right d-flex justify-content-between align-items-center">
                            <h3 class="card-title mb-0"><i class="fas fa-list"></i> Lista Facturas</h3>
                            <a href="{{ route('factura.create') }}" class="btn btn-light bg-gradient-light text-primary btn-sm">
