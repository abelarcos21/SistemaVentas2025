        ...
        <form action="{{ route('cotizaciones.update', $cotizacion->id) }}" method="POST" id="formCotizacion">
                    ...
                    <table class="table table-hover table-bordered" id="tablaProductos">
                        ...
                        <tbody id="cuerpoTabla">
                            ...
                            <tr>
                                ...
                                <td style="padding: 0.5rem;">
                                    <input type="number" name="precios[]" class="form-control precio text-right" step="0.01" value="{{ $detalle->precio_unitario }}" readonly>
                                </td>
                                <td style="padding: 0.5rem;">
            ...
            <div class="card-footer">
                <button type="submit" class="btn bg-gradient-info" id="btnGuardar">
                    <i class="fas fa-history"></i> Actualizar Cotización
                </button>
...
<script>
    ...
    // Eliminar fila con confirmación (SweetAlert2)
    $(document).on('click', '.btnEliminar', function () {
        let fila = $(this).closest('tr'); // Guardamos la fila
        Swal.fire({
            title: '¿Está seguro?',
