...
@section('title', 'Roles | Crear un nuevo Rol')
...
@section('content_header')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-user-shield"></i> Roles | Crear un nuevo Rol</h1>
                </div>
                <div class="col-sm-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            @foreach($permission as $value)
                                                <label class="text-info"><input type="checkbox" name="permission[{{$value->id}}]" value="{{$value->id}}" class="name">
                                                {{ $value->name }}</label>
                                            <br/>
                                            @endforeach
...
@section('js')
    <script>
        $(document).ready(function() {
            ...
            // Cuando se hace clic en el checkbox del módulo
            ...
            // Cuando se hace clic en un permiso individual
            $('.permission-checkbox').change(function() {
                var module = $(this).data('module');
                var totalPermissions = $('.permission-checkbox[data-module="' + module + '"]').length;
                var checkedPermissions = $('.permission-checkbox[data-module="' + module + '"]:checked').length;

                $('#module_' + module).prop('checked', totalPermissions === checkedPermissions);
            });

            // Al cargar, verificar el estado inicial de los módulos
