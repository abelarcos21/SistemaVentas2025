                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-gradient-primary text-right d-flex justify-content-between align-items-center">
                            <h3 class="card-title mb-0"><i class="fas fa-list"></i> Roles registrados</h3>
                            <a href="{{ route('roles.create') }}" class="btn btn-light bg-gradient-light text-primary btn-sm">
                            ...
                            <div class="table-responsive">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        ...
                                                        @can('role-edit')
                                                            <a class="btn btn-info bg-gradient-info btn-sm mr-1" href="{{ route('roles.edit',$role->id) }}">
                                                                <i class="fas fa-edit"></i> Editar
                                                            </a>
                                                        @endcan

                                                        @can('role-delete')
                                                            <form method="POST" class="formulario-eliminar" action="{{ route('roles.destroy', $role->id) }}" style="display:inline">
                                                                @csrf
                                                                @method('DELETE')
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="9" class="text-center">NO HAY Roles</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
...
@section('js')
                ...
                buttons: [
                    {
                        ...
                        filename: 'reporte_roles_' + new Date().toISOString().slice(0, 10),
                    ...
                    },
                    {
                        ...
                        filename: function() {
                            ...
                            return `reporte_roles_${timestamp}`;
                        },
    ...
    {{--ALERTA PARA ELIMINAR UN ROL--}}
    <script>
       $(document).ready(function() {
            // Delegación de eventos para formularios que pueden ser cargados dinámicamente
            $(document).on('submit', '.formulario-eliminar', function(e) {
                e.preventDefault(); // Detenemos el submit normal
                var form = this;
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        form.submit(); // Aquí vuelve a enviar el formulario
                    }
                });
            });
        });
