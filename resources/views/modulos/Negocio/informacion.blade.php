...
@section('content')
    ...
    <h4 class="font-weight-bold">Administre Su Información Empresarial (Negocio)</h4>
    <h5 class="text-muted">Boleta</h5>
    <p>La información a continuación se mostrará en las boletas y tickets generadas automáticamente.</p>
            ...
            <div class="col-md-9">
                <form method="POST" action="{{ route('negocio.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group border p-3">
                        ...
                        <small class="form-text text-muted">Tamaño recomendado: 272×315 px. Máx 250 KB.</small>
                    </div>
