                    ...
                    @forelse($ventas as $venta)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{-- route('detalle.vista.detalle', $venta->id) --}}" class="btn btn-info btn-sm">Detalle</a>
                            </td>
                            <td>
                                <a target="_blank" href="{{--route('detalle.ticket', $venta->id) --}}" class="btn btn-success btn-sm">Imprimir</a>
                            </td>
                            <td class="text-center">
